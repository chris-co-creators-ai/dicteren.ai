 ...
 */
async startDicterenKeysRecording(bindingId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("start_dicteren_keys_recording", { bindingId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async stopDicterenKeysRecording() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("stop_dicteren_keys_recording") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async getLicenseState() : Promise<LicenseInfo> {
 ...
 */
async activateLicense(licenseCode: string) : Promise<Result<LicenseInfo, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("activate_license", { licenseCode }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async startTrialCommand() : Promise<Result<LicenseInfo, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("start_trial_command") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async refreshLicenseState() : Promise<Result<LicenseInfo, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("refresh_license_state") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async hasLicenseToken() : Promise<boolean> {
    return await TAURI_INVOKE("has_license_token");
},
/**
 * Wipe the local token. Used by the lock-screen "Activeer andere code" action.
 */
async clearLicenseToken() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("clear_license_token") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async openBillingPage() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("open_billing_page") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async openPricingPage() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("open_pricing_page") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async openTrialStartPage() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("open_trial_start_page") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type EngineType = "Parakeet" | "Moonshine" | "MoonshineStreaming" | "SenseVoice" | "GigaAM" | "Canary" | "Cohere"
 ...
 */
"unknown" | "trial" | "active" | "past_due" | "canceled" | "expired" | "refunded" | "revoked"
