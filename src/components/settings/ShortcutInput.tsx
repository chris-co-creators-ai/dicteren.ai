...
import { DicterenKeysShortcutInput } from "./DicterenKeysShortcutInput";
 ...
 * - "dicteren_keys": Uses DicterenKeysShortcutInput with backend key events
 */
export const ShortcutInput: React.FC<ShortcutInputProps> = (props) => {
  ...
  if (keyboardImplementation === "dicteren_keys") {
    return <DicterenKeysShortcutInput {...props} />;
  }
