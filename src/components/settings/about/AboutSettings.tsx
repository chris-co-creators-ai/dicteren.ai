  ...
  return (
    ...
    >
      ...
      {license && license.status !== "unknown" && (
        <SettingsGroup title={t("settings.about.licenseSection")}>
          <SettingContainer
            title={
              isTrial
                ? t("settings.about.licenseStatus.trial")
                : t("settings.about.licenseStatus.active")
            }
          ...
          {hasActiveLicense && (
            <SettingContainer
              title={t("settings.about.deactivate.title")}
              description={t("settings.about.deactivate.description")}
              grouped={true}
            >
              <Button
                variant="secondary"
              ...
              >
                {t("settings.about.deactivate.button")}
              </Button>
            </SettingContainer>
          )}
        </SettingsGroup>
      ...
      {/* Account section */}
      <SettingsGroup title={t("settings.about.accountSection")}>
        <SettingContainer
          title={t("settings.about.myAccount.title")}
          description={t("settings.about.myAccount.description")}
          grouped={true}
        >
          <Button
            variant="secondary"
          ...
          >
            {t("settings.about.myAccount.button")}
          </Button>
        </SettingContainer>

        {hasActiveLicense && !isTrial && (
          <SettingContainer
            title={t("settings.about.myBilling.title")}
            description={t("settings.about.myBilling.description")}
            grouped={true}
          >
            <Button
              variant="secondary"
            ...
            >
              {t("settings.about.myBilling.button")}
            </Button>
          </SettingContainer>
        )}

        <SettingContainer
          title={t("settings.about.buyLicense.title")}
          description={t("settings.about.buyLicense.description")}
          grouped={true}
        >
          <Button
            variant="primary"
          ...
          >
            {t("settings.about.buyLicense.button")}
          </Button>
        </SettingContainer>
      </SettingsGroup>
