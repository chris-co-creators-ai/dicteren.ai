      ...
      <main className="p-6">
        ...
        <AffiliatesIndexClient
          affiliates={affiliates.map((a) => ({
            ...
            businessCommissionType: a.businessCommissionType,
            businessCommissionPct: a.businessCommissionPct,
            businessCommissionFixedCents: a.businessCommissionFixedCents,
            consumerCommissionType: a.consumerCommissionType,
            consumerCommissionPct: a.consumerCommissionPct,
            consumerCommissionFixedCents: a.consumerCommissionFixedCents,
