    ...
    <CrmContainer
      ...
      orgsProps={{
        ...
        organizations: orgs.map((o) => ({
          ...
          industry: o.industry,
          niche: o.niche,
          specialisatie: o.specialisatie,
          companySize: o.companySize,
          revenueRange: o.revenueRange,
          totalReach: o.totalReach,
          brancheVereniging: o.brancheVereniging,
          aantalVestigingen: o.aantalVestigingen,
          hoofdkantoor: o.hoofdkantoor,
          proposedPlanSlug: o.proposedPlanSlug,
