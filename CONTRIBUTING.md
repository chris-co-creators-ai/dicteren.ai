# Contributing to Dicteren.ai

Thank you for your interest in contributing to Dicteren.ai! This guide will help you get started with contributing to this open source speech-to-text application.

## ⚠️ Feature Freeze

**Dicteren.ai is currently undergoing a feature freeze.** If you are submitting a PR which is a new feature that the community has not asked for, it will be rejected. If the community has asked for it, or you have explicitly gathered support, it may still be considered.
...
Dicteren.ai aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/Dicteren.ai.git
   cd Dicteren.ai
   ```
...
3. **Add upstream remote**:
   ...
   ```bash
   git remote add upstream git@github.com:dicterenai/dicteren.ai.git
   ```
...
Dicteren.ai follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/christianbleeker/dicteren-ai/issues](https://github.com/christianbleeker/dicteren-ai/issues)
2. **Check discussions** at [github.com/christianbleeker/dicteren-ai/discussions](https://github.com/christianbleeker/dicteren-ai/discussions)
...
1. **Search existing discussions** at [github.com/christianbleeker/dicteren-ai/discussions](https://github.com/christianbleeker/dicteren-ai/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/christianbleeker/dicteren-ai/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/christianbleeker/dicteren-ai/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/christianbleeker/dicteren-ai/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with Dicteren.ai's philosophy
...
1. **Search existing issues and PRs** - Check both open AND closed issues and pull requests. Someone may have already addressed this, or there may be a reason it was closed.
   - [Open issues](https://github.com/christianbleeker/dicteren-ai/issues)
   - [Closed issues](https://github.com/christianbleeker/dicteren-ai/issues?q=is%3Aissue+is%3Aclosed)
   - [Open PRs](https://github.com/christianbleeker/dicteren-ai/pulls)
   - [Closed PRs](https://github.com/christianbleeker/dicteren-ai/pulls?q=is%3Apr+is%3Aclosed)
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/christianbleeker/dicteren-ai/discussions)
   - Link to that discussion in your PR

3. **Get community feedback for features** - PRs with demonstrated community interest are **much more likely to be merged**. Start a discussion, get feedback, and link to it in your PR. This helps ensure Dicteren.ai stays focused and useful for the most people without becoming bloated.

Community feedback is essential to keeping Dicteren.ai the best it can be for everyone. It helps prioritize what matters most and prevents feature creep.
...
7. **Create a Pull Request**:
   - Go to the [Dicteren.ai repository](https://github.com/christianbleeker/dicteren-ai)
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/christianbleeker/dicteren-ai/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/christianbleeker/dicteren-ai/discussions)
- **Email**: Reach out at [support@dicteren.ai](mailto:support@dicteren.ai)

## 📜 License

By contributing to Dicteren.ai, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Dicteren.ai!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
