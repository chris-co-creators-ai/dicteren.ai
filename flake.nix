{
  description = "Dicteren.ai - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          dicteren-ai = pkgs.rustPlatform.buildRustPackage {
            pname = "dicteren-ai";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/christianbleeker/dicteren-ai";
              license = lib.licenses.mit;
              mainProgram = "dicteren-ai";
              platforms = supportedSystems;
            };
          };

          default = self.packages.${system}.dicteren-ai;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.dicteren-ai.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.dicteren-ai;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.dicteren-ai.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.dicteren-ai;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Dicteren.ai development environment"
              bun install
