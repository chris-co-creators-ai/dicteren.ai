...
impl ModelManager {
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        // Whisper-engine + alle whisper-modellen zijn verwijderd: Dicteren.ai
        // levert uitsluitend het Parakeet/ONNX-pad. Dat scheelt whisper-rs-sys
        // en daarmee de cmake/libclang-build-vereiste op elke machine.
