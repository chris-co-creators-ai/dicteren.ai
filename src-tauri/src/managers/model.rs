...
impl ModelManager {
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/ggml-small.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/whisper-medium-q4_1.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/ggml-large-v3-turbo.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/ggml-large-v3-q5_0.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/breeze-asr-q5_k.bin".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/parakeet-v2-int8.tar.gz".to_string()),
                sha256: Some(
        ...
        // Dicteren.ai exposes Parakeet V3 as a Dutch-only model.
        let parakeet_v3_languages: Vec<String> = vec!["nl".to_string()];
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/moonshine-base.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(
                    "https://models.dicteren.ai/moonshine-tiny-streaming-en.tar.gz".to_string(),
                ),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(
                    "https://models.dicteren.ai/moonshine-small-streaming-en.tar.gz".to_string(),
                ),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some(
                    "https://models.dicteren.ai/moonshine-medium-streaming-en.tar.gz".to_string(),
                ),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/sense-voice-int8.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/giga-am-v3-int8.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/canary-180m-flash.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/canary-1b-v2.tar.gz".to_string()),
                sha256: Some(
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                url: Some("https://models.dicteren.ai/cohere-int8.tar.gz".to_string()),
                sha256: Some(
        ...
        // Dicteren.ai is intentionally shipped with a single consumer model.
        // Keeping this filter in the backend prevents old downloads or custom
        // models from reappearing through commands even if files exist on disk.
        available_models.retain(|id, _| id == "parakeet-tdt-0.6b-v3");
    ...
    pub async fn download_model(&self, model_id: &str) -> Result<()> {
        ...
        // Create HTTP client with explicit timeouts so DNS/hosting issues fail
        // quickly instead of leaving onboarding stuck at 0%.
